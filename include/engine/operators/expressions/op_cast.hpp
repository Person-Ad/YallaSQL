...
// namespace our {
// // cast left as right
// class OpCastExpression : public Expression {
//     std::unique_ptr<Expression> lhs_child, rhs_child;
//     DataType childType;
// public:
//     OpCastExpression(duckdb::Expression &expr): Expression(expr) {
//         exprType = ExpressionType::OP_CAST;

//         child = Expression::createExpression(
//             *expr.Cast<duckdb::CastExpression>().child
//         );
